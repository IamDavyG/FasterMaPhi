        ...
        with open(save_path,'a+') as data_file:
            ...
            for k in molecules_F:
                ...
                if normal_term == check_norm and conve_term == None:
                    ...
                    homo, homo1, homo2, HOMO, HOMO1, HOMO2 = calc_homo_values(molecule_file,electrons, c_converg)

                    lumo, lumo1, lumo2, LUMO, LUMO1, LUMO2 = calc_lumo_values(molecule_file,electrons, c_converg, homo)
                    hardness= LUMO - HOMO
