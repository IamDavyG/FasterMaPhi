...
from Maphi_cython import get_val, check_line
import cython
        ...
        with open(save_path,'a+') as data_file:
            ...
            for k in molecules_F:
                ...
                if normal_term == check_norm and conve_term == None:
                    ...
                    ElectronDonatingPower: float
                    ElectronAcceptingPower: float
                    NetElectrophilicity: float
                    ...
                    lumo1=(homo+2)
                    lumo2=(homo+3)
                    HOMO=(get_val("orca_input.out","OCC",homo,16,29,converg))
                    HOMO1=(get_val("orca_input.out","OCC",homo1,16,29,converg))
                    HOMO2=(get_val("orca_input.out","OCC",homo2,16,29,converg))
                    LUMO=(get_val("orca_input.out","OCC",lumo,16,29,converg))
                    LUMO1=(get_val("orca_input.out","OCC",lumo1,16,29,converg))
                    LUMO2=(get_val("orca_input.out","OCC",lumo2,16,29,converg))
                    hardness = float(LUMO) - float(HOMO)
                    ...
                    dipole = (get_val("orca_input.out","DIPOLE MOMENT",9,-11,-1,1))
                    quadXX = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,9,22,1))
                    quadYY = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,23,35,1))
                    quadZZ = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,36,48,1))
                    quadXY = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,49,60,1))
                    quadXZ = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,61,74,1))
                    quadYZ = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,75,87,1))
                    quadYZ = (get_val("orca_input.out","QUADRUPOLE MOMENT (A.U.)",6,75,87,1))
                    IsotropicQuad = (get_val("orca_input.out","Isotropic quadrupole",0,-11,-1,1))
