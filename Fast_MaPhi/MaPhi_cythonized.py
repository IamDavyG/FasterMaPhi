        ...
        with open(save_path,'a+') as data_file:
            ...
            for k in molecules_F:
                ...
                if normal_term == check_norm and conve_term == None:
                    ...
                    LUMO1: cython.float
                    LUMO2: cython.float
                    hardness: cython.float
                    electronegativity: cython.float
                    electrophilicity: cython.float
                    ElectronDonatingPower: cython.float
                    ElectronAcceptingPower: cython.float
                    NetElectrophilicity: cython.float
                    '''
